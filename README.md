...
- `LinearRegressionMM` inherits `MarketMaking` with its instance variables and extra rolling regression configurations. The only extra method is `predict_price` which performs a linear regrssion and prediction with data externally stored in class variable of `Trader` class, while the rolling part is implemented by queuing up to max rolling sizea. Orders for `STARFRUIT` is generaged by `LinearRegressionMM` class in the `run` method.
...
<div align=center><img src = "https://raw.githubusercontent.com/jimmylim0823/IMC-Prosperity-2/master/img/R2_PnL.png?raw=True" width="50%" height="50%"><div align=center>
...
<div align=center><img src = "https://raw.githubusercontent.com/jimmylim0823/IMC-Prosperity-2/master/img/R3_PnL.png?raw=True" width="50%" height="50%"><div align=center>
...
<div align=center><img src = "https://raw.githubusercontent.com/jimmylim0823/IMC-Prosperity-2/master/img/R4_PnL.png?raw=True" width="50%" height="50%"><div align=center>
...
<div align=center><img src = "https://raw.githubusercontent.com/jimmylim0823/IMC-Prosperity-2/master/img/R5_PnL.png?raw=True" width="50%" height="50%"><div align=center>
